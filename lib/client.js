	...
	factory: (require) => {
		...
		function Panel(props) {
			...
			return react.createElement("div", {
				className: "dr-panel",
				ref: panelRef
			}, react.createElement("div", { className: "dr-panel-head" }, react.createElement("span", null, "📖 精读助手"), react.createElement("button", {
				type: "button",
				className: "dr-close",
				title: "关闭",
		...
		function apply(ctx) {
			...
			ctx.slots.inject("shell.overlay", () => {
				...
				return () => {
					if (panelActions === registeredActions) panelActions = void 0;
					dispose();
				};
			});
			ctx.slots.inject("conversation.input.left", () => ctx.slots.register({
				...
				label: "精读",
				inject: () => ({ openPanel: () => {
					if (panelActions === void 0) pendingOpen = true;
