...
export interface HostContext {
    ...
    inject?(dependencies: readonly string[], callback: (ctx: HostContext) => void): HostInjectionFiber;
    ...
    get(name: 'agentDefaultModel'): {
        currentSelection(): unknown;
    } | undefined;
    get(name: string): unknown;
}
export declare function isRecord(value: unknown): value is Record<string, unknown>;
export declare function isHostContext(value: unknown): value is HostContext;
export declare function isBinaryFileService(value: unknown): value is Pick<FileService, 'resolve' | 'readBytes'>;
export declare function isTextFileService(value: unknown): value is Pick<FileService, 'resolve' | 'readText'>;
export declare function isFileWriter(value: unknown): value is Pick<FileService, 'resolve' | 'writeText'>;
export declare function isLlmCatalogService(value: unknown): value is Pick<LlmService, 'listProviders' | 'listModels'>;
export declare function isLlmStreamService(value: unknown): value is Pick<LlmService, 'stream'>;
