...
assert.ok(files.includes('lib/legacy/index.mjs'), 'package includes the internal legacy runtime adapter target')
assert.ok(files.includes('legacy/index.d.mts'), 'package includes the legacy boundary declaration used by the source entry')
